...
async function go() {
  let client = new MongoClient('mongodb+srv://todoAppUser:suku123@cluster0.lkwnr.mongodb.net/TodoApp?retryWrites=true&w=majority')
...
function passwordProtected(req, res, next){
  ...
  if(req.headers.authorization == "Basic c3VrdTpzdWt1"){
    next()
  }else{
